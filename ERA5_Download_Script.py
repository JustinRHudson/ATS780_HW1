...
def make_precip_request() -> None:
    ...
    #check if the file already exists if not make the request
    if not os.path.isfile(data_path + '/ERA5_precip_morn.nc'):
        c = cdsapi.Client()
    ...
    if not os.path.isfile(data_path + '/ERA5_precip_midday.nc'):
        c = cdsapi.Client()
        ...
        c.retrieve(
            ...
            'ERA5_precip_midday.nc')
    
    if not os.path.isfile(data_path + '/ERA5_precip_night.nc'):
        c = cdsapi.Client()
